...
QUESTIONS = {
    1: 'Write a pseudo code to print "Hello World"',
    2: 'Write a pseudo code to find the sum of two numbers',
    3: 'Write a pseudo code to check if a number is prime',
    4: 'Write a pseudo code to check if a number is odd'
}
...
def evaluate_pseudocode(pseudo_code, question_id):
    try:
        ...
        prompt = f"""
        Evaluate the following pseudocode for the given question and provide a score out of 10. 
