...
database = client["sproc-events"]
collection = database["pseudo"]
...
def evaluate_pseudocode(pseudo_code, question_id):
    try:
        ...
        prompt = f"""
        Evaluate the following pseudocode for the given question based on the logic don't look on syntax and stuffs like that and provide a score out of 10. DONT generate any descriptions or explanations or corrections, you are an invigilator correcting the answers, just do that.
